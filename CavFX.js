...
// include: C:\msys64\tmp\tmp37mshn6u.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'CavFX.data';
      var REMOTE_PACKAGE_BASE = 'CavFX.data';
...
Module['FS_createPath']("/texpacks", "default", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_CavFX.data');
      }
      Module['addRunDependency']('datafile_CavFX.data');
    ...
    loadPackage({"files": [{"filename": "/audio/calm1.ogg", "start": 0, "end": 2530812}, {"filename": "/audio/calm2.ogg", "start": 2530812, "end": 4507543}, {"filename": "/audio/calm3.ogg", "start": 4507543, "end": 6740194}, {"filename": "/audio/default.zip", "start": 6740194, "end": 9061804}, {"filename": "/audio/hal1.ogg", "start": 9061804, "end": 11034021}, {"filename": "/audio/hal2.ogg", "start": 11034021, "end": 12788450}, {"filename": "/audio/hal3.ogg", "start": 12788450, "end": 14711719}, {"filename": "/audio/hal4.ogg", "start": 14711719, "end": 17269971}, {"filename": "/texpacks/default.zip", "start": 17269971, "end": 17419607}, {"filename": "/texpacks/default/animations.png", "start": 17419607, "end": 17441483}, {"filename": "/texpacks/default/animations.txt", "start": 17441483, "end": 17442801}, {"filename": "/texpacks/default/char.png", "start": 17442801, "end": 17444161}, {"filename": "/texpacks/default/chicken.png", "start": 17444161, "end": 17444616}, {"filename": "/texpacks/default/clouds.png", "start": 17444616, "end": 17454491}, {"filename": "/texpacks/default/creeper.png", "start": 17454491, "end": 17457491}, {"filename": "/texpacks/default/default.png", "start": 17457491, "end": 17461187}, {"filename": "/texpacks/default/gui.png", "start": 17461187, "end": 17475146}, {"filename": "/texpacks/default/gui_classic.png", "start": 17475146, "end": 17489356}, {"filename": "/texpacks/default/icons.png", "start": 17489356, "end": 17491779}, {"filename": "/texpacks/default/items.png", "start": 17491779, "end": 17507502}, {"filename": "/texpacks/default/particles.png", "start": 17507502, "end": 17508076}, {"filename": "/texpacks/default/pig.png", "start": 17508076, "end": 17511867}, {"filename": "/texpacks/default/rain.png", "start": 17511867, "end": 17514420}, {"filename": "/texpacks/default/sheep.png", "start": 17514420, "end": 17516854}, {"filename": "/texpacks/default/sheep_fur.png", "start": 17516854, "end": 17518515}, {"filename": "/texpacks/default/skeleton.png", "start": 17518515, "end": 17519409}, {"filename": "/texpacks/default/snow.png", "start": 17519409, "end": 17520190}, {"filename": "/texpacks/default/spider.png", "start": 17520190, "end": 17522744}, {"filename": "/texpacks/default/terrain.png", "start": 17522744, "end": 17574601}, {"filename": "/texpacks/default/zombie.png", "start": 17574601, "end": 17575944}], "remote_package_size": 17575944});

  })();

// end include: C:\msys64\tmp\tmp37mshn6u.js
// include: C:\msys64\tmp\tmpj2_gav_y.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: C:\msys64\tmp\tmpj2_gav_y.js
// include: C:\msys64\tmp\tmp2ag28l16.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: C:\msys64\tmp\tmp2ag28l16.js
...
var _Http_OnUpdateProgress = Module['_Http_OnUpdateProgress'] = makeInvalidEarlyAccess('_Http_OnUpdateProgress');
var _Http_OnFinishedAsync = Module['_Http_OnFinishedAsync'] = makeInvalidEarlyAccess('_Http_OnFinishedAsync');
var _malloc = makeInvalidEarlyAccess('_malloc');
var _Directory_IterCallback = Module['_Directory_IterCallback'] = makeInvalidEarlyAccess('_Directory_IterCallback');
var _strerror = makeInvalidEarlyAccess('_strerror');
var _Platform_LogError = Module['_Platform_LogError'] = makeInvalidEarlyAccess('_Platform_LogError');
var _main = Module['_main'] = makeInvalidEarlyAccess('_main');
var _main_phase1 = Module['_main_phase1'] = makeInvalidEarlyAccess('_main_phase1');
var _main_phase2 = Module['_main_phase2'] = makeInvalidEarlyAccess('_main_phase2');
var _Window_RequestClipboardText = Module['_Window_RequestClipboardText'] = makeInvalidEarlyAccess('_Window_RequestClipboardText');
var _Window_StoreClipboardText = Module['_Window_StoreClipboardText'] = makeInvalidEarlyAccess('_Window_StoreClipboardText');
var _Window_GotClipboardText = Module['_Window_GotClipboardText'] = makeInvalidEarlyAccess('_Window_GotClipboardText');
var _Window_OnFileUploaded = Module['_Window_OnFileUploaded'] = makeInvalidEarlyAccess('_Window_OnFileUploaded');
var _Window_OnTextChanged = Module['_Window_OnTextChanged'] = makeInvalidEarlyAccess('_Window_OnTextChanged');
...
function assignWasmExports(wasmExports) {
  assert(typeof wasmExports['Http_OnUpdateProgress'] != 'undefined', 'missing Wasm export: Http_OnUpdateProgress');
  assert(typeof wasmExports['Http_OnFinishedAsync'] != 'undefined', 'missing Wasm export: Http_OnFinishedAsync');
  assert(typeof wasmExports['malloc'] != 'undefined', 'missing Wasm export: malloc');
  assert(typeof wasmExports['Directory_IterCallback'] != 'undefined', 'missing Wasm export: Directory_IterCallback');
  assert(typeof wasmExports['strerror'] != 'undefined', 'missing Wasm export: strerror');
  assert(typeof wasmExports['Platform_LogError'] != 'undefined', 'missing Wasm export: Platform_LogError');
  assert(typeof wasmExports['__main_argc_argv'] != 'undefined', 'missing Wasm export: __main_argc_argv');
  assert(typeof wasmExports['main_phase1'] != 'undefined', 'missing Wasm export: main_phase1');
  assert(typeof wasmExports['main_phase2'] != 'undefined', 'missing Wasm export: main_phase2');
  assert(typeof wasmExports['Window_RequestClipboardText'] != 'undefined', 'missing Wasm export: Window_RequestClipboardText');
  assert(typeof wasmExports['Window_StoreClipboardText'] != 'undefined', 'missing Wasm export: Window_StoreClipboardText');
  assert(typeof wasmExports['Window_GotClipboardText'] != 'undefined', 'missing Wasm export: Window_GotClipboardText');
  assert(typeof wasmExports['Window_OnFileUploaded'] != 'undefined', 'missing Wasm export: Window_OnFileUploaded');
  assert(typeof wasmExports['Window_OnTextChanged'] != 'undefined', 'missing Wasm export: Window_OnTextChanged');
  ...
  _Http_OnUpdateProgress = Module['_Http_OnUpdateProgress'] = createExportWrapper('Http_OnUpdateProgress', 3);
  _Http_OnFinishedAsync = Module['_Http_OnFinishedAsync'] = createExportWrapper('Http_OnFinishedAsync', 4);
  _malloc = createExportWrapper('malloc', 1);
  _Directory_IterCallback = Module['_Directory_IterCallback'] = createExportWrapper('Directory_IterCallback', 1);
  _strerror = createExportWrapper('strerror', 1);
  _Platform_LogError = Module['_Platform_LogError'] = createExportWrapper('Platform_LogError', 1);
  ...
  _Window_RequestClipboardText = Module['_Window_RequestClipboardText'] = createExportWrapper('Window_RequestClipboardText', 0);
  _Window_StoreClipboardText = Module['_Window_StoreClipboardText'] = createExportWrapper('Window_StoreClipboardText', 1);
  _Window_GotClipboardText = Module['_Window_GotClipboardText'] = createExportWrapper('Window_GotClipboardText', 1);
  _Window_OnFileUploaded = Module['_Window_OnFileUploaded'] = createExportWrapper('Window_OnFileUploaded', 1);
  _Window_OnTextChanged = Module['_Window_OnTextChanged'] = createExportWrapper('Window_OnTextChanged', 1);
